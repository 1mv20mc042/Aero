                ...
                <div className="footer">
                    <div className="main">
                        ...
                        <div className="list">
                            <h4>Contact Info</h4>
                            <ul>
                                <li><a>107, Shree Sai Dham , Above Barista Cafe, Vikrant Circle,Ghatkopar East Mumbai -400077.</a></li>
                                <li><a> Mumbai -400077.</a></li>
                                <li><a>+91-9920092957 | +91-9820092957</a></li>
                                <li><a>aerotours111@gmail.com</a></li>
                            </ul>
                        </div>
                        {/* list */}
                        <div className="list">
